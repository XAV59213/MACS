"""Constants for the M.A.C.S. integration."""
...
MACS_DEVICE_ID = "macs"
MACS_DEVICE_NAME = "M.A.C.S."
MACS_MANUFACTURER = "XAV59213 / Glyn Davidson"
MACS_MODEL = "Mood-Aware Character SVG"

MACS_DEVICE = DeviceInfo(
    identifiers={(DOMAIN, MACS_DEVICE_ID)},
    name=MACS_DEVICE_NAME,
    manufacturer=MACS_MANUFACTURER,
    model=MACS_MODEL,
)
