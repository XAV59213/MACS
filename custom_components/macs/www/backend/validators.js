...
/*
 * Mapping Assist Satellite + Echo Dot / Alexa.
 *
 * Les vrais assist_satellite utilisent souvent :
 * - idle
 * - listening
 * - processing
 * - responding
 *
 * Les Echo Dot / Alexa en media_player utilisent plutôt :
 * - standby
 * - idle
 * - playing
 * - paused
 ...
 * - unavailable
 *
 * Ce mapping permet au moins à MACS de réagir sans planter.
 */
...
export function getEntityNumericAttribute(entity, attribute, fallback = null) {
	return toNumber(
		getEntityAttribute(entity, attribute, fallback),
		fallback
	);
}
...
/**
 * Convertit un état Assist Satellite / Echo Dot en humeur MACS.
 */
